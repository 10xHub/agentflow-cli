"""
Content block models for multimodal message support.

This module defines various content block types that can be used in messages,
including text, images, audio, video, documents, data, tool calls, and more.
"""
